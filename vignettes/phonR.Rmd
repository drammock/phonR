...
with(indo, plotVowels(f1, f2, vowel, group=gender))
```
...
par(mfrow=c(1, 2))
with(indo, plotVowels(f1, f2, col.by=vowel, style.by=vowel, pretty=TRUE))
with(indo, plotVowels(f1, f2, col.by=gender, style.by=vowel, pretty=TRUE))
```
...
with(indo, plotVowels(f1, f2, vowel, group=subj, plot.tokens=FALSE, 
                      ...
                      pretty=TRUE))
with(indo, plotVowels(f1, f2, vowel, group=gender, plot.tokens=FALSE, 
                      plot.means=TRUE, col.by=gender, style.by=vowel, 
                      pretty=TRUE))
```
