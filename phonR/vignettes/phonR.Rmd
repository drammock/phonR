...
with(indo, plotVowels(f1, f2, xlab="F2 (Hertz)", ylab="F1 (Hertz)", main="Vowel formant frequencies"))
```
...
with(indo, plotVowels(f1, f2, vowel, group=subj, xlab="F2 (Hertz)", ylab="F1 (Hertz)", main="Vowel formant frequencies"))
```
...
with(females, plotVowels(f1, f2, vowel, group=gender, plot.tokens=TRUE, pch.tokens=vowel, alpha.tokens=0.5, plot.means=TRUE, pch.means=ipaglyphs, cex.means=4, col.by=vowel, family="Linux Libertine O", pretty=TRUE))
```
...
```{r, fig.show='hold', fig.cap=""}
with(indo, plotVowels(f1, f2, vowel, group=gender, plot.tokens=TRUE, pch.tokens=vowel, cex.tokens=0.8, alpha.tokens=0.4, plot.means=TRUE, pch.means=vowel, cex.means=2, col.by=vowel, ellipse.fill=TRUE, pretty=TRUE))
with(indo, plotVowels(f1, f2, vowel, group=gender, plot.tokens=TRUE, pch.tokens=vowel, cex.tokens=0.8, alpha.tokens=0.4, plot.means=TRUE, pch.means=vowel, cex.means=2, col.by=vowel, ellipse.fill=TRUE, ellipse.conf=0.05, pretty=TRUE))
```
...
```{r, fig.show='hold', fig.cap=""}
with(indo, plotVowels(f1, f2, vowel, group=gender, plot.tokens=TRUE, pch.tokens=vowel, cex.tokens=0.8, alpha.tokens=0.4, plot.means=TRUE, pch.means=vowel, cex.means=2, col.by=vowel, style.by=gender, ellipse.fill=TRUE, poly.line=TRUE, poly.order=c("i", "e", "a", "o", "u"), pretty=TRUE))
...
```{r, fig.show='hold', fig.cap=""}
with(indo, plotVowels(f1, f2, vowel, group=gender, plot.tokens=TRUE, pch.tokens=vowel, alpha.tokens=0.5, plot.means=TRUE, pch.means=vowel, cex.means=2, col.by=vowel, style.by=gender, hull.fill=TRUE, hull.line=TRUE, fill.opacity=0.1, pretty=TRUE))
with(indo, plotVowels(f1, f2, vowel, group=gender, plot.tokens=TRUE, pch.tokens=vowel, alpha.tokens=0.5, plot.means=TRUE, pch.means=vowel, cex.means=2, col.by=gender, style.by=gender, hull.fill=TRUE, hull.line=TRUE, fill.opacity=0.1, pretty=TRUE))
```
