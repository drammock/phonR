...
knitr::opts_chunk$set(collapse=TRUE, cache=TRUE, comment="#>", warning=FALSE, message=FALSE, tidy=TRUE, tidy.opts=list(blank=FALSE, width.cutoff=90), fig.path="images/", dev="cairo_pdf", fig.align="center", fig.width=12, fig.height=12)
```
...
# useRaster gets passed through to the underlying `graphics::image()` function
```
