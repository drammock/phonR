...
par(mfrow=c(1, 2))
with(indo, plotVowels(f1, f2, vowel, group=subj, plot.tokens=FALSE, plot.means=TRUE, var.col.by=gender, var.style.by=vowel, pretty=TRUE, xlim=c(3000, 500), ylim=c(1000, 250)))
with(indo, plotVowels(f1, f2, vowel, group=gender, plot.tokens=FALSE, plot.means=TRUE, var.col.by=gender, var.style.by=vowel, pretty=TRUE, xlim=c(3000, 500), ylim=c(1000, 250)))
```
