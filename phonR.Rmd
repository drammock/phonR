...
```{r grayscale, dependson=c("load-phonR"), fig.height=6}
par(mfrow=c(1, 2))
...
```{r overlays-one, dependson=c("load-phonR"), fig.height=6}
...
```{r dry, dependson=c("overlays-one"), fig.width=6, fig.height=6}
xlim <- c(3500, 500)
ylim <- c(1200, 200)
...
```{r overlays-two, dependson=c("overlays-one"), fig.width=9, fig.height=9}
