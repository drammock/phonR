...
# FIXME: off-graph plotting discovered: plotVowels(data=d, f1='F1', f2='F2', vowel='vowel', grouping.factor='group', single.plot=TRUE, norm.method='logmean', points='none', ellipses=FALSE, match.unit=FALSE) # (d3, excl nwf)
# FIXME: allow font to be user-specified
